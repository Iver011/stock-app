  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="flex items-center gap-3 text-gray-4
          hover:text-yellow-500"
        >
          <Avatar className="h-8 w-8">
            <AvatarImage src="https://avatars.githubusercontent.com/u/155501056?s=400&u=d38ef6ff0150a9cb6290016f2e0950a6623f3b85&v=4"></AvatarImage>
            <AvatarFallback
      ...
      <DropdownMenuContent className="text-gray-400">
        ...
        <DropdownMenuItem
          ...
          focus:bg-trasparent focus:text-yellow-500 transition-colors cursor-pointer"
        >
